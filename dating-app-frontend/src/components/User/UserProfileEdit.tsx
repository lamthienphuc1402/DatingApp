...
import {useSubmitRegister} from "../Auth/hooks/useRegister.ts";
...
const UserProfileEdit = ({userId, onUpdate}: { userId: string; onUpdate: () => void }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        formData.append("profilePictures", newProfilePictures[0]);
        console.log(newProfilePictures[0]);
    ...
    return (
        <div className="bg-white bg-opacity-90 rounded-3xl shadow-2xl p-8 max-w-2xl w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-pink-100 rounded-xl p-6 mb-6">
                    <label htmlFor="interests" className="block text-sm font-medium text-pink-800 mb-1">Sở thích (cách
